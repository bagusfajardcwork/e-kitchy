    ...
    <b-col sm="12" lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          ...
          <div class="alert alert-success alert-dismissible fade show mb-3 d-flex gap-2" role="alert">
            <i class="ph ph-thumbs-up"></i>
            <span class="text-success"> This is a success alert—check it out!</span>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
          <div class="alert alert-info alert-dismissible fade show mb-3 d-flex gap-2" role="alert">
            <i class="ph ph-bell-ringing"></i>
            <span> This is a info alert—check it out!</span>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
          <div class="alert alert-warning alert-dismissible fade show mb-3 d-flex gap-2" role="alert">
            <i class="ph ph-bell-ringing"></i>
  ...
  <b-row>
    <b-col sm="12" lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          <div class="alert alert-solid alert-success alert-dismissible fade show mb-3 d-flex gap-2" role="alert">
            <i class="ph ph-thumbs-up"></i>
            <span> This is a success alert—check it out!</span>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
          <div class="alert alert-solid alert-info alert-dismissible fade show mb-3 d-flex gap-2" role="alert">
            <i class="ph ph-bell-ringing"></i>
            <span> This is a info alert—check it out!</span>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
          <div class="alert alert-solid alert-warning alert-dismissible fade show mb-3 d-flex gap-2" role="alert">
            <i class="ph ph-bell-ringing"></i>
            <span> This is a warning alert—check it out!</span>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
          <div class="alert alert-solid alert-danger alert-dismissible fade show d-flex gap-2" role="alert">
            <i class="ph ph-lifebuoy"></i>
            <span> This is a danger alert—check it out!</span>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
  ...
  <b-row>
    <b-col sm="12">
      <b-card no-body>
        ...
        <b-card-body>
          ...
          <div class="alert alert-top alert-info alert-dismissible fade show mb-3 d-flex gap-2" role="alert">
            <i class="ph ph-bell-ringing"></i>
            <span> This is a info alert—check it out!</span>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
          <div class="alert alert-right alert-warning alert-dismissible fade show mb-3 d-flex gap-2" role="alert">
            <i class="ph ph-bell-ringing"></i>
            <span> This is a warning alert—check it out!</span>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
          <div class="alert alert-bottom alert-danger alert-dismissible fade show d-flex gap-2" role="alert">
            <i class="ph ph-lifebuoy"></i>
            <span> This is a danger alert—check it out!</span>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
    ...
    <b-col lg="12">
      <b-card no-body>
        ...
        <b-card-body>
          <div class="alert alert-success rounded-0 alert-dismissible fade show d-flex gap-2" role="alert">
            <i class="ph ph-lifebuoy"></i>
            <span> This is a success alert—check it out!</span>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>

          <div class="alert alert-success alert-solid rounded-0 alert-dismissible fade show d-flex gap-2" role="alert">
            <i class="ph ph-lifebuoy"></i>
            <span> This is a success alert—check it out!</span>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
