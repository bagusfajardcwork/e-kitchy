        ...
        <b-card no-body>
          ...
          <b-card-body>
            <p>Toasts are as flexible as you need and have very little required markup. At a minimum, we require a
              single
              element to contain your “toasted” content and strongly encourage a dismiss button.</p>
        ...
        <b-card no-body>
          ...
          <b-card-body>
            <p>Toasts are slightly translucent, too, so they blend over whatever they might appear over. For browsers
              that
              support the <code>backdrop-filter</code> CSS property, we’ll also attempt to blur the elements under a
              toast.</p>
            <div class="p-3 bg-dark">
              <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                <div class="toast-header">
                ...
                <div style="position: relative; top: 0; right: 0">
                  ...
                  <div class="toast fade show mb-2" role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="toast-header">
                      ...
                      <strong class="me-auto">Bootstrap</strong>
                      <small class="text-muted">just now</small>
                      <button type="button" class="ms-2 mb-1 btn-close" data-dismiss="toast"
          ...
          <b-card-body>
            ...
            <div class="toast fade show bg-primary text-white border-0 mt-3" role="alert" aria-live="assertive"
              ...
              <div class="toast-header bg-primary text-white">
                ...
                <small>11 mins ago</small>
                <button type="button" class="ms-2 mb-1 btn-close text-white" data-dismiss="toast"
                  aria-label="Close"></button>
              </div>
              <div class="toast-body">Hello, world! This is a toast message.</div>
            </div>
