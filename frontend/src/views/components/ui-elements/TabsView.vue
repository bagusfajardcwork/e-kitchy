<template>
    <b-row>
      <b-col sm="12" lg="6" class="col-sm-12 col-lg-6">
        <b-card no-body>
          <b-card-header class="mb-0 d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Basic Tabs</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
            <p>The base
              ...
              demonstrate that this particular class does not trigger any
              special styling.
            </p>
        ...
        <b-card no-body>
          <b-card-header class="mb-0 d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Basic Tabs Style 3</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
            ...
            <ul class="nav nav-tabs" id="myTab-two" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="home-tab-two" data-bs-toggle="tab" href="#home-two" role="tab"
                  aria-selected="true">Home</a>
              </li>
              <li class="nav-item">
        ...
        <b-card no-body>
          <b-card-header class="mb-0 d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Tabs Vertical Pills</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
        ...
        <b-card no-body>
          <b-card-header class="mb-0 d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Tabs Justify Center</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
            ...
            <ul class="nav nav-tabs justify-content-center" id="myTab-2" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="home-tab-justify" data-bs-toggle="tab" href="#home-justify" role="tab"
                  aria-selected="true">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="profile-tab-justify" data-bs-toggle="tab" href="#profile-justify" role="tab"
                  aria-selected="false">Profile</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="contact-tab-justify" data-bs-toggle="tab" href="#contact-justify" role="tab"
                  aria-selected="false">Contact</a>
              </li>
            </ul>
      ...
      <b-col sm="12" lg="6">
        <b-card no-body>
          <b-card-header class="mb-0 d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Basic Tabs Style 2</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
        ...
        <b-card no-body>
          <b-card-header class="mb-0 d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Basic Tabs Style 4</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
            <p>Takes the basic nav from above and adds the
            ...
            <ul class="nav nav-tabs" id="myTab-three" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="contact-tab-three" data-bs-toggle="tab" href="#contact-three" role="tab"
                  aria-selected="false">Contact</a>
              </li>
            </ul>
        ...
        <b-card no-body>
          <b-card-header class="mb-0 d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Tabs Fill and Justify</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
            <p>Force your
              <code>.nav</code>’s contents to extend the full available width
              one of two modifier classes. To proportionately fill all
              available space with your
            ...
            <ul class="nav nav-pills mb-3 nav-fill" id="pills-tab-1" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="pills-home-tab-fill" data-bs-toggle="pill" href="#pills-home-fill"
                  role="tab" aria-selected="true">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="pills-profile-tab-fill" data-bs-toggle="pill" href="#pills-profile-fill"
                  role="tab" aria-selected="false">Profile</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="pills-contact-tab-fill" data-bs-toggle="pill" href="#pills-contact-fill"
        ...
        <b-card no-body>
          <b-card-header class="mb-0 d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Tabs Justify Right</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
