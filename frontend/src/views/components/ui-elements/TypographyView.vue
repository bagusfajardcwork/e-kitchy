    ...
    <b-row>
          ...
          <b-card-body>
            <p>Traditional heading elements are designed to work best in the meat of your page content. When you need a
              ...
              heading style. Keep in mind these headings are not responsive by default, but it’s possible to enable <a
                href="https://getbootstrap.com/" target="_blank">responsive font sizes</a>.</p>
      ...
      <b-col sm="12" lg="6">
        <b-card no-body>
          <b-card-header class="d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Typography</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
        ...
        <b-card no-body>
          <b-card-header class="d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Inline text elements</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
        ...
        <b-card no-body>
          <b-card-header class="d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Lists Inline</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
      ...
      <b-col sm="12" lg="6">
        <b-card no-body>
          <b-card-header class="d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Headings</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
        ...
        <b-card no-body>
          <b-card-header class="d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Lists Unstyled</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
        ...
        <b-card no-body>
          <b-card-header class="d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Blockquotes</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
      ...
      <b-col sm="12">
        <b-card no-body>
          <b-card-header class="d-flex justify-content-between">
            <div class="header-title">
              <b-card-title>Description list alignment</b-card-title>
            </div>
          </b-card-header>
          <b-card-body>
            ...
            <dl class="row">
              ...
              <dd class="col-sm-9 me-0">A description list is perfect for defining terms.</dd>
              <dt class="col-sm-3">Euismod</dt>
              <dd class="col-sm-9 me-0">
                <p>Vestibulum id ligula porta felis euismod semper eget lacinia odio sem nec elit.</p>
                <p>Donec id elit non mi porta gravida at eget metus.</p>
              </dd>
              <dt class="col-sm-3">Malesuada porta</dt>
              <dd class="col-sm-9 me-0">Etiam porta sem malesuada magna mollis euismod.</dd>
              <dt class="col-sm-3 text-truncate">Truncated term is truncated</dt>
              <dd class="col-sm-9 me-0">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut
                fermentum
                massa justo sit amet risus.</dd>
              <dt class="col-sm-3">Nesting</dt>
              <dd class="col-sm-9 me-0">
                <dl class="row">
                  <dt class="col-sm-4 me-0">Nested definition list</dt>
                  <dd class="col-sm-8 me-0">Aenean posuere, tortor sed cursus feugiat, nunc augue blandit nunc.</dd>
                </dl>
              </dd>
            </dl>
          </b-card-body>
