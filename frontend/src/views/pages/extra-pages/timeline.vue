  ...
  <b-row class="justify-content-center">
    <b-col lg="6">
      <b-card no-body>
        ...
        <b-card-body>
          <div class="timeline0 m-0 d-flex align-items-center justify-content-between position-relative">
            <ul class="list-inline p-0 m-0">
              <li>
                <div class="timeline-dots1 border-primary text-primary d-flex justify-content-center">
                ...
                <small class="float-right mt-1">24 November
                  2019</small>
              ...
              <li>
                <div class="timeline-dots1 border-success text-success d-flex justify-content-center">
                  <svg class="icon-20" width="20" viewBox="0 0 24 24">
                    <path fill="currentColor"
                ...
                <h6 class="float-left mb-1">Scheduled
                  Maintenance</h6>
                <small class="float-right mt-1">23 November
                  2019</small>
                <div class="d-inline-block w-100">
                  <p>Bonbon macaroon jelly beans gummi bears jelly
                    lollipop apple</p>
              ...
              <li>
                <div class="timeline-dots1 border-danger text-danger d-flex justify-content-center">
                  <svg class="icon-20" width="20" viewBox="0 0 24 24">
                    <path fill="currentColor"
                ...
                <small class="float-right mt-1">20 November
                  2019</small>
                <div class="d-inline-block w-100">
              ...
              <li>
                ...
                <small class="float-right mt-1">19 November
                  2019</small>
                <div class="d-inline-block w-100">
                  <p>Bonbon macaroon jelly beans gummi bears jelly
                    lollipop apple</p>
              ...
              <li>
                <div class="timeline-dots1 border-warning text-warning d-flex justify-content-center">
                  <svg class="icon-20" width="20" viewBox="0 0 24 24">
                    <path fill="currentColor"
                ...
                <small class="float-right mt-1">15 November
                  2019</small>
                <div class="d-inline-block w-100">
                  <p>Bonbon macaroon jelly beans gummi bears jelly
                    lollipop apple</p>
    ...
    <b-col lg="6">
      <b-card no-body>
        <b-card-header class="d-flex justify-content-between">
          <div class="header-title">
            <b-card-title>Small Dots Timeline</b-card-title>
          </div>
        </b-card-header>
        <b-card-body>
          <ul class="timeline">
            <li v-for="(event, index) in timelineEvents" :key="index">
              <div :class="['timeline-dots', event.dotClass]"></div>
              <div class="d-flex justify-content-between">
                <h6 class="mb-1">{{ event.title }}</h6>
                <small class="mt-1">{{ event.date }}</small>
              </div>
              <div class="d-inline-block w-100">
